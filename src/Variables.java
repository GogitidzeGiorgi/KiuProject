...
public class Variables {
    ...
    public static void vars(String code) {
        ...
        for (int i =0; i<Lines.size(); i++){
            if (InputCounter.isDigit) digitCount.put(i, InputCounter.DigitCounter(Lines.get(i)));
        ...
        // Variable Integer
        if (InputCounter.isDigit) {
            for (String line : Lines) {
                if (InputCounter.checkInt1(line.substring(line.indexOf(":=")))) {
